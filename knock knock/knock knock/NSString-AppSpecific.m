...
int kMinUsernameLength = 3;
int kMaxUsernameLength = 32;
int kMinPasswordLength = 3;
...
{
    DDLogVerbose(@"input:%@ min:%lu max:%lu", self, (unsigned long)minLength, (unsigned long)maxLength);
